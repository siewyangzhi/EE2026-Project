...
set_property PACKAGE_PIN V17 [get_ports {ManualSwitch}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ManualSwitch}]
set_property PACKAGE_PIN V16 [get_ports {ChangeBorderSwitch}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ChangeBorderSwitch}]
set_property PACKAGE_PIN W16 [get_ports {OffBorderSwitch}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {OffBorderSwitch}]
set_property PACKAGE_PIN W17 [get_ports {OffVolumeSwitch}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {OffVolumeSwitch}]
set_property PACKAGE_PIN W15 [get_ports {Color_Scheme_Type}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Color_Scheme_Type}]
...
set_property PACKAGE_PIN W13 [get_ports {MenuSwitch}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MenuSwitch}]
#set_property PACKAGE_PIN V2 [get_ports {sw[8]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sw[8]}]
#set_property PACKAGE_PIN T3 [get_ports {sw[9]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sw[9]}]
#set_property PACKAGE_PIN T2 [get_ports {speedo}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {speedo}]
set_property PACKAGE_PIN R3 [get_ports {checkraw6}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {checkraw6}]
set_property PACKAGE_PIN W2 [get_ports {tunemode}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {tunemode}]
set_property PACKAGE_PIN U1 [get_ports {speedo}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {speedo}]
set_property PACKAGE_PIN T1 [get_ports {sonarmode}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sonarmode}]
set_property PACKAGE_PIN R2 [get_ports {taptapmode}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {taptapmode}]
...
##Pmod Header JXADC
##Sch name = XA1_P
#set_property PACKAGE_PIN J3 [get_ports {pmodoledrgb_cs}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {pmodoledrgb_cs}]
##Sch name = XA2_P
#set_property PACKAGE_PIN L3 [get_ports {pmodoledrgb_sdin}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {pmodoledrgb_sdin}]
##Sch name = XA3_P
#set_property PACKAGE_PIN M2 [get_ports {JX[2]}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {JXADC[2]}]
##Sch name = XA4_P
#set_property PACKAGE_PIN N2 [get_ports {pmodoledrgb_sclk}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {pmodoledrgb_sclk}]
##Sch name = XA1_N
#set_property PACKAGE_PIN K3 [get_ports {pmodoledrgb_d_cn}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {pmodoledrgb_d_cn}]
##Sch name = XA2_N
#set_property PACKAGE_PIN M3 [get_ports {pmodoledrgb_resn}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {pmodoledrgb_resn}]
##Sch name = XA3_N
#set_property PACKAGE_PIN M1 [get_ports {pmodoledrgb_vccen}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {pmodoledrgb_vccen}]
##Sch name = XA4_N
#set_property PACKAGE_PIN N1 [get_ports {pmodoledrgb_pmoden}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {pmodoledrgb_pmoden}]
